...
from pmodular.services.packing_service import calculate_optimal_material_usage
...
class Part(models.Model):
    ...
    material = models.ForeignKey(WoodEn, related_name='modular_parts_using_this_wood', on_delete=models.SET_NULL, null=True, blank=True)
    ...
    top_edge_band = models.ForeignKey(EdgeBand, related_name='modularparts_with_top_eb', on_delete=models.SET_NULL, null=True, blank=True)
    left_edge_band = models.ForeignKey(EdgeBand, related_name='modularparts_with_left_eb', on_delete=models.SET_NULL, null=True, blank=True)
    bottom_edge_band = models.ForeignKey(EdgeBand, related_name='modularparts_with_bottom_eb', on_delete=models.SET_NULL, null=True, blank=True)
    right_edge_band = models.ForeignKey(EdgeBand, related_name='modularparts_with_right_eb', on_delete=models.SET_NULL, null=True, blank=True)
...
class PartHardware(models.Model):
    ...
    hardware = models.ForeignKey(Hardware, related_name="modular_hardware_links", on_delete=models.CASCADE)
...
class ModularProductMaterialOverride(models.Model):
    ...
    wooden_material = models.ForeignKey(
        WoodEn,
        on_delete=models.PROTECT,
        related_name='modular_material_overrides',
...
class Review(models.Model):
    product = models.ForeignKey('Product', on_delete=models.CASCADE, related_name="modular_reviews")
