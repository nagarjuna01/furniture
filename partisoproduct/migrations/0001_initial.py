    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compatible_woods', models.ManyToManyField(blank=True, related_name='parts_by_wood', to='material.wooden')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='partisoproduct.quoterequest')),
            ],
        ),
        migrations.CreateModel(
            name='QuotePartDetail',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('selected_material', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='material.wooden')),
                ('quote_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='part_details', to='partisoproduct.quoteproduct')),
            ],
        ),
        migrations.CreateModel(
            name='Constraint',
