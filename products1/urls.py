...
router = DefaultRouter()
router.register("product-types", ProductTypeViewSet, basename="p1-product-type")
router.register("product-series", ProductSeriesViewSet, basename="product-series")
router.register("products", ProductViewSet, basename="product")
router.register("product-variants", ProductVariantViewSet, basename="product-variant")
router.register("attributes", AttributeDefinitionViewSet, basename="attribute")
router.register("product-images", ProductImageViewSet, basename="product-image")
router.register("variant-images", VariantImageViewSet, basename="variant-image")
router.register("variant-attributes", VariantAttributeValueViewSet, basename="variant-attribute")
router.register(r'product-bundles', views.ProductBundleViewSet, basename='product-bundle')
...
urlpatterns = [
    ...
    # ------------- Admin / Internal ------
    path("admin/master/", master_admin_view, name="master-admin"),
    path("admin/products/", product_management_view, name="product-management"),

    # ------------- Customer View ---------
    path("products/", customer_product_list, name="customer-product-list"),
]
